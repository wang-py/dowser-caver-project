...
if not os.path.exists("../data/clusters"):
	cmd.cd("/home/miller96/Software/dowserplusplus/dpp_original/dowserplusplus/files/result/with_Q/caver_output/1/pymol")
...
if load_trajectory:
	...
	cmd.load('../data/cavity_glu_prot_Q10_EM_100kJ_water.pdb', 'structure')
